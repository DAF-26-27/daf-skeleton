 ...
 * }
 * @psalm-type SlickJsonApiConfig = array{
 *     version?: scalar|Param|null, // The version set on JSON API document. See https://jsonapi.org/format/#document-jsonapi-object // Default: "1.1"
 *     server_url?: scalar|Param|null, // The server name used in all links exposed in the JSON API document. // Default: "http://localhost"
 * }
 ...
 *     slick_json_api?: SlickJsonApiConfig,
 *     twig?: TwigConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
